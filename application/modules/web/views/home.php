            ...
            <div uk-slider="finite: true" class="course-grid-slider">
                ...
                <ul
                        ...
                        <a href="course-lesson-1.html">
                            <div class="course-card-resume">
                                <div class="course-card-resume-thumbnail">
                                    <img src="<?php echo base_url()?>/assets/images/course/2.png">
                                </div>
                    ...
                    <li> <a href="course-lesson-1.html">
                            <div class="course-card-resume">
                                <div class="course-card-resume-thumbnail">
                                    <img src="<?php echo base_url()?>/assets/images/course/1.png">
                                </div>
                                <div class="course-card-resume-body">
                    ...
                    <li> <a href="course-lesson-1.html">
                            <div class="course-card-resume">
                                <div class="course-card-resume-thumbnail">
                                    <img src="<?php echo base_url()?>/assets/images/course/7.png">
                                </div>
                                <div class="course-card-resume-body">
                    ...
                    <li>
                        <a href="course-lesson-1.html">
                            <div class="course-card-resume">
                                <div class="course-card-resume-thumbnail">
                                    <img src="<?php echo base_url()?>/assets/images/course/3.png">
                                </div>
                                <div class="course-card-resume-body">
                                    <h5> Ultimate Web Designer And Developer Course </h5>
                                    <span class="number"> 3/20 </span>
                    ...
                    <li>
                        <a href="course-lesson-1.html">
                            <div class="course-card-resume">
                                <div class="course-card-resume-thumbnail">
                                    <img src="<?php echo base_url()?>/assets/images/course/4.png">
                                </div>
                                <div class="course-card-resume-body">
                                    <h5>Angular Fundamentals From Scratch To Experts</h5>
                                    <span class="number"> 3/20 </span>
                        ...
                        <a href="episode-details.html">
                            <div class="course-card episode-card animate-this">
                                <div class="course-card-thumbnail ">
                                    ...
                                    <img src="<?php echo base_url()?>/assets/images/episodes/2.png">
                        ...
                        <a href="episode-details.html">
                            <div class="course-card episode-card animate-this">
                                <div class="course-card-thumbnail ">
                                    ...
                                    <img src="<?php echo base_url()?>/assets/images/episodes/3.png">
                                    <span class="play-button-trigger"></span>
                                </div>
                                <div class="course-card-body">
                        ...
                        <a href="episode-details.html">
                            <div class="course-card episode-card animate-this">
                                <div class="course-card-thumbnail ">
                                    ...
                                    <span class="duration">5:39</span>
                                    <img src="<?php echo base_url()?>/assets/images/episodes/1.png">
                                    <span class="play-button-trigger"></span>
                                </div>
                                <div class="course-card-body">
                        ...
                        <a href="episode-details.html">
                            <div class="course-card episode-card animate-this">
                                <div class="course-card-thumbnail ">
                                    ...
                                    <span class="duration">2:39</span>
                                    <img src="<?php echo base_url()?>/assets/images/episodes/5.png">
                                    <span class="play-button-trigger"></span>
                                </div>
                                <div class="course-card-body">
                ...
                <ul class="uk-slider-items uk-child-width-1-4@m uk-child-width-1-3@s uk-grid">
                    ...
                    <li>
                        <a href="course-intro.html">
                            <div class="course-card">
                                <div class="course-card-thumbnail ">
                                    <img src="<?php echo base_url()?>/assets/images/course/6.png">
                                    <span class="play-button-trigger"></span>
                                </div>
                                <div class="course-card-body">
                                    <div class="course-card-info">
                    ...
                    <li>
                        <a href="course-intro.html">
                            <div class="course-card">
                                <div class="course-card-thumbnail ">
                                    <img src="<?php echo base_url()?>/assets/images/course/5.png">
                                    <span class="play-button-trigger"></span>
                                </div>
                                <div class="course-card-body">
                                    <div class="course-card-info">
