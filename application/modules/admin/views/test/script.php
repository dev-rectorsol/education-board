...
$('#__qusnbank_select').select2({
  ajax: {
    url: '<?php echo base_url('admin/question/get_qusnbank'); ?>',
    type: "POST",
    dataType: 'json',
...
$("#__qusnbank_select").on('change', function(e) {
  var data = $("#__qusnbank_select").select2("data", e.choice);
