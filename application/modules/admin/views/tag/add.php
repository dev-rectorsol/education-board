      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="product-status-wrap drp-lst">
            <form action="<?php echo base_url('admin/tag/add')?>" method="POST">
              <h4>Add Tag </h4>
          ...
          <div class="sparkline13-list">
            <div class="sparkline13-hd">
              <div class="main-sparkline13-hd">
                <h1>Tag <span class="table-project-n">Data</span> List</h1>
              </div>
            </div>
...
<script>
  function delete_detail(id) {
    ...
    if (del == true) {
        window.location = "<?php echo base_url()?>admin/tag/delete/" + id;
      }
    }
</script>
