						...
						<div class="sparkline13-list">
							<div class="sparkline13-hd">
								<div class="main-sparkline13-hd">
									<h1>Trending <span class="table-project-n">Video</span> List</h1>
									<div class="add-product">
										<a href="<?php echo base_url('admin/lesson/trending'); ?>">Add New</a>
									</div>
								</div>
							</div>
									...
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-click-to-select="true" data-toolbar="#toolbar">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="<?php echo base_url('admin/lesson/edit_trending/').$value['lesson_id']; ?>"> <button type="button" class="btn btn-default"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button> </a>
