							...
							<div class="sparkline13-hd">
								<div class="main-sparkline13-hd">
									...
									<div class="add-product">
										<a href="<?php echo base_url('admin/lesson/'); ?>">Add New</a>
									</div>
								</div>
							</div>
									...
									<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-click-to-select="true" data-toolbar="#toolbar">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $value['lacturcount']; ?></td>
												<td><?php echo my_date_show($value['created_at']) ?></td>
												<td>
													<a href="<?php echo base_url('admin/lesson/edit/').$value['lesson_id']; ?>"> <button type="button" class="btn btn-default"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button> </a>
